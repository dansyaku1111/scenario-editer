...
type Props = {
    onAddNode: (type: 'start' | 'action' | 'condition' | 'end' | 'image' | 'content') => void;
...
export default function Toolbar(props: Props) {
    ...
    return (
        <div className="toolbar flex gap-4 items-center flex-wrap">
            ...
            <button onClick={() => props.onAddNode('content')} className="px-4 py-2 bg-teal-500 text-white rounded hover:bg-teal-600">コンテンツノード追加</button>
